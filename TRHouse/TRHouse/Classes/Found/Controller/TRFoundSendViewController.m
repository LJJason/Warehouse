...
@interface TRFoundSendViewController ()<UITextViewDelegate,CZComposeToolBarDelegate, AlbumNavigationControllerDelegate>
...
@implementation TRFoundSendViewController
